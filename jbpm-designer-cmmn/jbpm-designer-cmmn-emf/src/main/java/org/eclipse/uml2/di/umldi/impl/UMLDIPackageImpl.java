...
public class UMLDIPackageImpl extends EPackageImpl implements UMLDIPackage {
     ...
     * @generated
     */
    public EReference getUMLShape_ChildShapes() {
        return (EReference)umlShapeEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EAttribute getUMLCompartment_IsExpanded() {
     ...
     * @generated
     */
    public EReference getUMLCompartment_ChildShapes() {
        return (EReference)umlCompartmentEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EAttribute getUMLCompartment_FeatureName() {
        return (EAttribute)umlCompartmentEClass.getEStructuralFeatures().get(2);
    }
    ...
    public void createPackageContents() {
        ...
        createEReference(umlShapeEClass, UML_SHAPE__CHILD_SHAPES);
        ...
        createEAttribute(umlCompartmentEClass, UML_COMPARTMENT__IS_EXPANDED);
        createEReference(umlCompartmentEClass, UML_COMPARTMENT__CHILD_SHAPES);
    ...
    public void initializePackageContents() {
        ...
        initEReference(getUMLShape_ChildShapes(), theDiPackage.getDiagramElement(), null, "childShapes", null, 0, -1, UMLShape.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getUMLCompartment_IsExpanded(), theXMLTypePackage.getBoolean(), "isExpanded", null, 0, 1, UMLCompartment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getUMLCompartment_ChildShapes(), theDiPackage.getDiagramElement(), null, "childShapes", null, 0, -1, UMLCompartment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
