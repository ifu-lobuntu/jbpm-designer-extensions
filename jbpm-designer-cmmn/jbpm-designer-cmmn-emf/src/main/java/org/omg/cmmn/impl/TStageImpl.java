 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TStageImpl#getPlanningTable <em>Planning Table</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TStageImpl#getPlanItemDefinitionGroup <em>Plan Item Definition Group</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TStageImpl#getPlanItemDefinition <em>Plan Item Definition</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TStageImpl#isAutoComplete <em>Auto Complete</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TStageImpl#getExitCriteriaRefs <em>Exit Criteria Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TStageImpl extends TPlanFragmentImpl implements TStage {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TSTAGE;
    }
    ...
    public NotificationChain basicSetPlanningTable(TPlanningTable newPlanningTable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CMMNPackage.TSTAGE__PLANNING_TABLE, oldPlanningTable, newPlanningTable);
    ...
    public void setPlanningTable(TPlanningTable newPlanningTable) {
        if (newPlanningTable != planningTable) {
            ...
            if (planningTable != null)
                msgs = ((InternalEObject)planningTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TSTAGE__PLANNING_TABLE, null, msgs);
            if (newPlanningTable != null)
                msgs = ((InternalEObject)newPlanningTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TSTAGE__PLANNING_TABLE, null, msgs);
            msgs = basicSetPlanningTable(newPlanningTable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TSTAGE__PLANNING_TABLE, newPlanningTable, newPlanningTable));
    }
    ...
    public FeatureMap getPlanItemDefinitionGroup() {
        if (planItemDefinitionGroup == null) {
            planItemDefinitionGroup = new BasicFeatureMap(this, CMMNPackage.TSTAGE__PLAN_ITEM_DEFINITION_GROUP);
        }
    ...
    public EList<TPlanItemDefinition> getPlanItemDefinition() {
        return getPlanItemDefinitionGroup().list(CMMNPackage.Literals.TSTAGE__PLAN_ITEM_DEFINITION);
    }
    ...
    public void setAutoComplete(boolean newAutoComplete) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TSTAGE__AUTO_COMPLETE, oldAutoComplete, autoComplete, !oldAutoCompleteESet));
    }
    ...
    public void unsetAutoComplete() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CMMNPackage.TSTAGE__AUTO_COMPLETE, oldAutoComplete, AUTO_COMPLETE_EDEFAULT, oldAutoCompleteESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case CMMNPackage.TSTAGE__PLANNING_TABLE:
                return basicSetPlanningTable(null, msgs);
            case CMMNPackage.TSTAGE__PLAN_ITEM_DEFINITION_GROUP:
                return ((InternalEList<?>)getPlanItemDefinitionGroup()).basicRemove(otherEnd, msgs);
            case CMMNPackage.TSTAGE__PLAN_ITEM_DEFINITION:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CMMNPackage.TSTAGE__AUTO_COMPLETE:
                return isAutoComplete();
            case CMMNPackage.TSTAGE__EXIT_CRITERIA_REFS:
