 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getDefinitionRef <em>Definition Ref</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemImpl#getTargetRefs <em>Target Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TCaseFileItemImpl extends TCmmnElementImpl implements TCaseFileItem {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TCASE_FILE_ITEM;
    }
    ...
    public NotificationChain basicSetChildren(TChildren newChildren, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM__CHILDREN, oldChildren, newChildren);
    ...
    public void setChildren(TChildren newChildren) {
        if (newChildren != children) {
            ...
            if (children != null)
                msgs = ((InternalEObject)children).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TCASE_FILE_ITEM__CHILDREN, null, msgs);
            if (newChildren != null)
                msgs = ((InternalEObject)newChildren).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TCASE_FILE_ITEM__CHILDREN, null, msgs);
            msgs = basicSetChildren(newChildren, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM__CHILDREN, newChildren, newChildren));
    }
    ...
    public void setDefinitionRef(TCaseFileItemDefinition newDefinitionRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM__DEFINITION_REF, oldDefinitionRef, definitionRef));
    }
    ...
    public void setMultiplicity(MultiplicityEnum newMultiplicity) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM__MULTIPLICITY, oldMultiplicity, multiplicity, !oldMultiplicityESet));
    }
    ...
    public void unsetMultiplicity() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CMMNPackage.TCASE_FILE_ITEM__MULTIPLICITY, oldMultiplicity, MULTIPLICITY_EDEFAULT, oldMultiplicityESet));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CMMNPackage.TCASE_FILE_ITEM__NAME:
                return getName();
            case CMMNPackage.TCASE_FILE_ITEM__SOURCE_REF:
                return getSourceRef();
            case CMMNPackage.TCASE_FILE_ITEM__TARGET_REFS:
