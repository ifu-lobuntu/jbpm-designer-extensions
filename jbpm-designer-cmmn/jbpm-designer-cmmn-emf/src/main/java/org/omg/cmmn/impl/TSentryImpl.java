 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TSentryImpl#getOnPartGroup <em>On Part Group</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TSentryImpl#getOnPart <em>On Part</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TSentryImpl#getIfPart <em>If Part</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TSentryImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TSentryImpl extends TCmmnElementImpl implements TSentry {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TSENTRY;
    }
    ...
    public FeatureMap getOnPartGroup() {
        if (onPartGroup == null) {
            onPartGroup = new BasicFeatureMap(this, CMMNPackage.TSENTRY__ON_PART_GROUP);
        }
        return onPartGroup;
    }
    ...
    public EList<TOnPart> getOnPart() {
        return getOnPartGroup().list(CMMNPackage.Literals.TSENTRY__ON_PART);
    }
    ...
    public NotificationChain basicSetIfPart(TIfPart newIfPart, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CMMNPackage.TSENTRY__IF_PART, oldIfPart, newIfPart);
    ...
    public void setIfPart(TIfPart newIfPart) {
        if (newIfPart != ifPart) {
            ...
            if (ifPart != null)
                msgs = ((InternalEObject)ifPart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TSENTRY__IF_PART, null, msgs);
            if (newIfPart != null)
                msgs = ((InternalEObject)newIfPart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TSENTRY__IF_PART, null, msgs);
            msgs = basicSetIfPart(newIfPart, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TSENTRY__IF_PART, newIfPart, newIfPart));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TSENTRY__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CMMNPackage.TSENTRY__IF_PART:
                return getIfPart();
            case CMMNPackage.TSENTRY__NAME:
                return getName();
        }
