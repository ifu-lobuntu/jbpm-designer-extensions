 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemStartTriggerImpl#getStandardEvent <em>Standard Event</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TCaseFileItemStartTriggerImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TCaseFileItemStartTriggerImpl extends TStartTriggerImpl implements TCaseFileItemStartTrigger {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TCASE_FILE_ITEM_START_TRIGGER;
    }
    ...
    public void setStandardEvent(CaseFileItemTransition newStandardEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM_START_TRIGGER__STANDARD_EVENT, oldStandardEvent, standardEvent, !oldStandardEventESet));
    }
    ...
    public void unsetStandardEvent() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CMMNPackage.TCASE_FILE_ITEM_START_TRIGGER__STANDARD_EVENT, oldStandardEvent, STANDARD_EVENT_EDEFAULT, oldStandardEventESet));
    }
    ...
    public void setSourceRef(TCaseFileItem newSourceRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TCASE_FILE_ITEM_START_TRIGGER__SOURCE_REF, oldSourceRef, sourceRef));
    }
