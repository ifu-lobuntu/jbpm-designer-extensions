...
var b=new ORYX.Plugins.ShapeMenuButton({callback:this.editTaskForm.bind(this),icon:ORYX.BASE_FILE_PATH+"images/processforms.png",align:ORYX.CONFIG.SHAPEMENU_TOP,group:1,msg:ORYX.I18N.View.editTaskForm});
var d=new ORYX.Plugins.ShapeMenuButton({callback:this.viewNodeSource.bind(this),icon:ORYX.BASE_FILE_PATH+"images/view.png",align:ORYX.CONFIG.SHAPEMENU_TOP,group:2,msg:ORYX.I18N.ShapeMenuPlugin.viewSourceNode});
...
this.facade.offer({name:ORYX.I18N.lockNode.lock,functionality:this.locknodes.bind(this),group:"lockunlockgroup",icon:ORYX.BASE_FILE_PATH+"images/lock.png",description:ORYX.I18N.lockNode.lock_desc,index:1,minShape:1,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)});
this.facade.offer({name:ORYX.I18N.lockNode.unlock,functionality:this.unlocknodes.bind(this),group:"lockunlockgroup",icon:ORYX.BASE_FILE_PATH+"images/unlock.png",description:ORYX.I18N.lockNode.unlock_desc,index:2,minShape:1,maxShape:0,isEnabled:function(){return ORYX.READONLY!=true
}.bind(this)})
