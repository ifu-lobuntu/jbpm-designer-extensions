...
<head profile="http://purl.org/NET/erdf/profile">
  ...
  <!-- schemas -->
    ...
    <script xmlns="http://www.w3.org/1999/xhtml" src="<%=request.getContextPath()%>/org.jbpm.designer.jBPMDesigner/js/Plugins/shaperepository.js" type="text/javascript"></script>
    <script xmlns="http://www.w3.org/1999/xhtml" src="<%=request.getContextPath()%>/org.jbpm.designer.jBPMDesigner/js/Plugins/cmmn1.0/cmmn.js" type="text/javascript"></script>
    <script xmlns="http://www.w3.org/1999/xhtml" src="<%=request.getContextPath()%>/org.jbpm.designer.jBPMDesigner/js/Plugins/vdml1.0/vdml.js" type="text/javascript"></script>
    <script xmlns="http://www.w3.org/1999/xhtml" src="<%=request.getContextPath()%>/org.jbpm.designer.jBPMDesigner/js/Plugins/uml2/classdiagram.js" type="text/javascript"></script>
    <!-- dynamic properties -->
    <script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript" src="<%=request.getContextPath()%>/editor/?uuid=<%=request.getParameter("uuid")%>&profile=<%=request.getParameter("profile")%>&pp=<%=request.getParameter("pp")%>&editorid=<%=request.getParameter("editorid")%>&readonly=<%=request.getParameter("readonly")%>&ts=<%=request.getParameter("ts")%>&sessionId=<%=request.getParameter("sessionId")%>"></script>
