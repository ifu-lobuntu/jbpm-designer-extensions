...
ORYX.CONFIG.STENCIL_GROUP_ORDER=function(){var a={"http://b3mn.org/stencilset/bpmn2.0#":{Tasks:1,"Start Events":3,"Catching Intermediate Events":5,"Throwing Intermediate Events":6,"End Events":4,Gateways:7,Subprocesses:2,"Service Tasks":8,"Connecting Objects":9,"Data Objects":10,Swimlanes:11,Artifacts:12,"Workflow Patterns":13},"http://b3mn.org/stencilset/cmmn1.0#":{Containers:1,"Plan Items":2,"Discretionary Items":3,"Case File Items":4,Events:5,Sentries:6},"http://b3mn.org/stencilset/vdmlactivitynetwork.0#":{Containers:1,Elements:2}};
return a
};
