...
public class CmmnFormBuilder extends AbstractFormBuilderImpl {
    ...
    public Map<String, TaskFormInfo> addFields(String repositoryInfo, Form form, EObject eobject, String formType) throws Exception {
        ...
        //TODO check if the "out" suffix is necessary at all.
    ...
    protected boolean maybePrepareSubform(String repositoryInfo, Field field, TCaseParameter parameter, Map<String, TaskFormInfo> results) {
        ...
        if (br != null && br.getDefinitionRef() != null && br.getDefinitionRef().getImportRef() != null && br.getDefinitionRef().getStructureRef() != null) {
            ...
            if (cls instanceof org.eclipse.uml2.uml.Class) {
                results.putAll(prepareSubform(repositoryInfo, field, cls, true));
                return true;
            }
        }
        return false;
