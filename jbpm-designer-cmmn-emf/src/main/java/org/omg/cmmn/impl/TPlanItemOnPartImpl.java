 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TPlanItemOnPartImpl#getStandardEvent <em>Standard Event</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TPlanItemOnPartImpl#getSentryRef <em>Sentry Ref</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TPlanItemOnPartImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPlanItemOnPartImpl extends TOnPartImpl implements TPlanItemOnPart {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TPLAN_ITEM_ON_PART;
    }
    ...
    public void setStandardEvent(PlanItemTransition newStandardEvent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TPLAN_ITEM_ON_PART__STANDARD_EVENT, oldStandardEvent, standardEvent, !oldStandardEventESet));
    }
    ...
    public void unsetStandardEvent() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CMMNPackage.TPLAN_ITEM_ON_PART__STANDARD_EVENT, oldStandardEvent, STANDARD_EVENT_EDEFAULT, oldStandardEventESet));
    }
    ...
    public void setSentryRef(TSentry newSentryRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TPLAN_ITEM_ON_PART__SENTRY_REF, oldSentryRef, sentryRef));
    }
    ...
    public void setSourceRef(TPlanItem newSourceRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TPLAN_ITEM_ON_PART__SOURCE_REF, oldSourceRef, sourceRef));
    }
