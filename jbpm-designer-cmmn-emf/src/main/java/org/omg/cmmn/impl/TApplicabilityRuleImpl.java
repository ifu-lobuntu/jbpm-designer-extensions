 ...
 * <ul>
 *   <li>{@link org.omg.cmmn.impl.TApplicabilityRuleImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.omg.cmmn.impl.TApplicabilityRuleImpl#getContextRef <em>Context Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TApplicabilityRuleImpl extends TCmmnElementImpl implements TApplicabilityRule {
    ...
    protected EClass eStaticClass() {
        return CMMNPackage.Literals.TAPPLICABILITY_RULE;
    }
    ...
    public NotificationChain basicSetCondition(TExpression newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CMMNPackage.TAPPLICABILITY_RULE__CONDITION, oldCondition, newCondition);
    ...
    public void setCondition(TExpression newCondition) {
        if (newCondition != condition) {
            ...
            if (condition != null)
                msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TAPPLICABILITY_RULE__CONDITION, null, msgs);
            if (newCondition != null)
                msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CMMNPackage.TAPPLICABILITY_RULE__CONDITION, null, msgs);
            msgs = basicSetCondition(newCondition, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TAPPLICABILITY_RULE__CONDITION, newCondition, newCondition));
    }
    ...
    public void setContextRef(TCaseFileItem newContextRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CMMNPackage.TAPPLICABILITY_RULE__CONTEXT_REF, oldContextRef, contextRef));
    }
