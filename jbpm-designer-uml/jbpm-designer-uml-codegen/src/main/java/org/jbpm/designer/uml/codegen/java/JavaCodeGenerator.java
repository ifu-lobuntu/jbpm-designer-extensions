...
import org.jbpm.designer.uml.code.metamodel.CodeFieldValue;
...
import org.jbpm.designer.uml.code.metamodel.LibraryTypeReference;
...
import org.jbpm.designer.uml.code.metamodel.expressions.StaticFieldExpression;
import org.jbpm.designer.uml.code.metamodel.expressions.StaticMethodCallExpression;
...
public class JavaCodeGenerator extends AbstractCodeGenerator {
    ...
    protected String getMappedName(CodeTypeReference type) {
        if (type instanceof PrimitiveTypeReference) {
            ...
            if (kind instanceof OclStandardLibrary) {
                ...
                case COLLECTIONS:
                    return "org.jbpm.common.Collections";
                case MATH:
                    return "java.util.Math";
                case PRIMITIVES:
    ...
    public JavaCodeGenerator interpretExpression(CodeExpression exp) {
        ...
        } else if (exp instanceof MappedExpression) {
            append(((MappedExpression) exp).getExpressionIn(getLanguage()));
