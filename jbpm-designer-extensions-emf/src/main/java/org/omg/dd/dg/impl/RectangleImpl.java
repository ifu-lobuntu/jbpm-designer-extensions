 ...
 * <ul>
 *   <li>{@link org.omg.dd.dg.impl.RectangleImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link org.omg.dd.dg.impl.RectangleImpl#getCornerRadius <em>Corner Radius</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RectangleImpl extends GraphicalElementImpl implements Rectangle {
     ...
     * @ordered
     */
    protected static final Double CORNER_RADIUS_EDEFAULT = new Double(0.0);
    ...
    public void setCornerRadius(Double newCornerRadius) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DGPackage.RECTANGLE__CORNER_RADIUS, oldCornerRadius, cornerRadius));
    }
