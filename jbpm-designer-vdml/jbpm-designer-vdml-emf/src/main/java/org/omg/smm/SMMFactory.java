...
public interface SMMFactory extends EFactory {
    ...
    /**
	 * Returns a new object of class '<em>Counting Measure Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Counting Measure Relationship</em>'.
	 * @generated
	 */
	CountingMeasureRelationship createCountingMeasureRelationship();
