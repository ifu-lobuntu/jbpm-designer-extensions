 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.smm.impl.Base1MeasureRelationshipImpl#getFromBinaryMeasure <em>From Binary Measure</em>}</li>
 *   <li>{@link org.omg.smm.impl.Base1MeasureRelationshipImpl#getToDimensionalMeasure <em>To Dimensional Measure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Base1MeasureRelationshipImpl extends BaseMeasureRelationshipImpl implements Base1MeasureRelationship {
    /**
    ...
    public BinaryMeasure getFromBinaryMeasure() {
		if (eContainerFeatureID() != SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE) return null;
    ...
    public NotificationChain basicSetFromBinaryMeasure(BinaryMeasure newFromBinaryMeasure, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFromBinaryMeasure, SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE, msgs);
		return msgs;
	}
    ...
    public void setFromBinaryMeasure(BinaryMeasure newFromBinaryMeasure) {
		if (newFromBinaryMeasure != eInternalContainer() || (eContainerFeatureID() != SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE && newFromBinaryMeasure != null)) {
			...
			if (newFromBinaryMeasure != null)
				msgs = ((InternalEObject)newFromBinaryMeasure).eInverseAdd(this, SMMPackage.BINARY_MEASURE__BASE_MEASURE1_TO, BinaryMeasure.class, msgs);
			msgs = basicSetFromBinaryMeasure(newFromBinaryMeasure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE, newFromBinaryMeasure, newFromBinaryMeasure));
	}
		...
		if (toDimensionalMeasure != null && toDimensionalMeasure.eIsProxy()) {
			...
			if (toDimensionalMeasure != oldToDimensionalMeasure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SMMPackage.BASE1_MEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE, oldToDimensionalMeasure, toDimensionalMeasure));
			}
		}
    ...
    public void setToDimensionalMeasure(DimensionalMeasure newToDimensionalMeasure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SMMPackage.BASE1_MEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE, oldToDimensionalMeasure, toDimensionalMeasure));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SMMPackage.BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE:
				return eInternalContainer().eInverseRemove(this, SMMPackage.BINARY_MEASURE__BASE_MEASURE1_TO, BinaryMeasure.class, msgs);
		}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SMMPackage.BASE1_MEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE:
