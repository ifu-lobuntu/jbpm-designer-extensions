...
public class SMMAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SMMSwitch<Adapter> modelSwitch =
        new SMMSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCountingMeasureRelationship(CountingMeasureRelationship object) {
				return createCountingMeasureRelationshipAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.omg.smm.SmmElement <em>Smm Element</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.omg.smm.SmmRelationship <em>Smm Relationship</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.omg.smm.SmmModel <em>Smm Model</em>}'.
	 * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    public Adapter createSmmModelAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link org.omg.smm.CountingMeasureRelationship <em>Counting Measure Relationship</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCountingMeasureRelationshipAdapter() {
		return null;
	}
