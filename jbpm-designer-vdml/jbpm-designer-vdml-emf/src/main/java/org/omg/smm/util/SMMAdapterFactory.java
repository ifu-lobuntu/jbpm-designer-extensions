...
public class SMMAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SMMSwitch<Adapter> modelSwitch =
        new SMMSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseEObject(org.omg.smm.EObject object) {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.omg.smm.string <em>string</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.omg.smm.EObject <em>EObject</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
