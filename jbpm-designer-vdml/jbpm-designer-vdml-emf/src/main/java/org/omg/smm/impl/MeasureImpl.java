...
public abstract class MeasureImpl extends AbstractMeasureElementImpl implements Measure {
    /**
     * The cached value of the '{@link #getMeasureLabelFormat() <em>Measure Label Format</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    protected string measureLabelFormat;

    /**
     * The cached value of the '{@link #getMeasurementLabelFormat() <em>Measurement Label Format</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    protected string measurementLabelFormat;
    ...
    /**
     * The cached value of the '{@link #getCustomScale() <em>Custom Scale</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getCustomScale()
     * @generated
    ...
    public string getMeasureLabelFormat() {
        if (measureLabelFormat != null && measureLabelFormat.eIsProxy()) {
            InternalEObject oldMeasureLabelFormat = (InternalEObject)measureLabelFormat;
            measureLabelFormat = (string)eResolveProxy(oldMeasureLabelFormat);
            if (measureLabelFormat != oldMeasureLabelFormat) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SMMPackage.MEASURE__MEASURE_LABEL_FORMAT, oldMeasureLabelFormat, measureLabelFormat));
            }
        }
     ...
     * @generated
     */
    public string basicGetMeasureLabelFormat() {
        return measureLabelFormat;
    }
    ...
    public string getMeasurementLabelFormat() {
        if (measurementLabelFormat != null && measurementLabelFormat.eIsProxy()) {
            InternalEObject oldMeasurementLabelFormat = (InternalEObject)measurementLabelFormat;
            measurementLabelFormat = (string)eResolveProxy(oldMeasurementLabelFormat);
            if (measurementLabelFormat != oldMeasurementLabelFormat) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SMMPackage.MEASURE__MEASUREMENT_LABEL_FORMAT, oldMeasurementLabelFormat, measurementLabelFormat));
            }
        }
     ...
     * @generated
     */
    public string basicGetMeasurementLabelFormat() {
        return measurementLabelFormat;
    }
    ...
    public string getSource() {
        if (source != null && source.eIsProxy()) {
            ...
            source = (string)eResolveProxy(oldSource);
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SMMPackage.MEASURE__SOURCE, oldSource, source));
            }
        }
        return source;
    }
    ...
    public string getCustomScale() {
        if (customScale != null && customScale.eIsProxy()) {
            InternalEObject oldCustomScale = (InternalEObject)customScale;
            customScale = (string)eResolveProxy(oldCustomScale);
            if (customScale != oldCustomScale) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SMMPackage.MEASURE__CUSTOM_SCALE, oldCustomScale, customScale));
            }
        }
        return customScale;
    }
     ...
     * @generated
     */
    public string basicGetCustomScale() {
        return customScale;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SMMPackage.MEASURE__MEASURE_LABEL_FORMAT:
                if (resolve) return getMeasureLabelFormat();
                return basicGetMeasureLabelFormat();
            case SMMPackage.MEASURE__MEASUREMENT_LABEL_FORMAT:
                if (resolve) return getMeasurementLabelFormat();
                return basicGetMeasurementLabelFormat();
            ...
            case SMMPackage.MEASURE__CUSTOM_SCALE:
                if (resolve) return getCustomScale();
                return basicGetCustomScale();
        }
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            case SMMPackage.MEASURE__MEASURE_LABEL_FORMAT:
                setMeasureLabelFormat((string)null);
                return;
            case SMMPackage.MEASURE__MEASUREMENT_LABEL_FORMAT:
                setMeasurementLabelFormat((string)null);
                return;
            case SMMPackage.MEASURE__VISIBLE:
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case SMMPackage.MEASURE__MEASURE_LABEL_FORMAT:
                return measureLabelFormat != null;
            case SMMPackage.MEASURE__MEASUREMENT_LABEL_FORMAT:
                return measurementLabelFormat != null;
            case SMMPackage.MEASURE__VISIBLE:
