...
public class SMMSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SMMPackage.COUNTING_MEASURE_RELATIONSHIP: {
				CountingMeasureRelationship countingMeasureRelationship = (CountingMeasureRelationship)theEObject;
				T result = caseCountingMeasureRelationship(countingMeasureRelationship);
				if (result == null) result = caseMeasureRelationship(countingMeasureRelationship);
				if (result == null) result = caseSmmRelationship(countingMeasureRelationship);
				if (result == null) result = caseSmmElement(countingMeasureRelationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Counting Measure Relationship</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Counting Measure Relationship</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCountingMeasureRelationship(CountingMeasureRelationship object) {
		return null;
	}
