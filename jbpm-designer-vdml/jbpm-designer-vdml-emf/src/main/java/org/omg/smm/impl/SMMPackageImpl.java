...
public class SMMPackageImpl extends EPackageImpl implements SMMPackage {
	 ...
	 * @generated
	 */
	private EClass countingMeasureRelationshipEClass = null;
    ...
    public static SMMPackage init() {
		...
		SMMDIPackageImpl theSMMDIPackage = (SMMDIPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(SMMDIPackage.eNS_URI) instanceof SMMDIPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(SMMDIPackage.eNS_URI) : SMMDIPackage.eINSTANCE);
	 ...
	 * @generated
	 */
    public EAttribute getScope_Stereotype() {
	 ...
	 * @generated
	 */
    public EOperation getScope__IsSpecified__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
    public EReference getBase1MeasureRelationship_FromBinaryMeasure() {
	 ...
	 * @generated
	 */
    public EReference getBase1MeasureRelationship_ToDimensionalMeasure() {
	 ...
	 * @generated
	 */
    public EReference getBaseNMeasureRelationship_FromCollectiveMeasure() {
		return (EReference)baseNMeasureRelationshipEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
    public EReference getBaseNMeasureRelationship_ToDimensionalMeasure() {
		return (EReference)baseNMeasureRelationshipEClass.getEStructuralFeatures().get(1);
	}
    ...
    public EReference getCollectiveMeasure_BaseMeasureTo() {
		return (EReference)collectiveMeasureEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
    public EReference getBase2MeasureRelationship_FromBinaryMeasure() {
	 ...
	 * @generated
	 */
    public EReference getBase2MeasureRelationship_ToDimensionalMeasure() {
    ...
    public EReference getBinaryMeasure_BaseMeasure2To() {
		return (EReference)binaryMeasureEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getCountingMeasure_CountedMeasureTo() {
		return (EReference)countingMeasureEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
    public EReference getMeasureLibrary_OwnedDiagram() {
		return (EReference)measureLibraryEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getCountingMeasureRelationship() {
		return countingMeasureRelationshipEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCountingMeasureRelationship_FromCountingMeasure() {
		return (EReference)countingMeasureRelationshipEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCountingMeasureRelationship_ToCountedMeasure() {
		return (EReference)countingMeasureRelationshipEClass.getEStructuralFeatures().get(1);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(scopeEClass, SCOPE__STEREOTYPE);
		createEOperation(scopeEClass, SCOPE___IS_SPECIFIED__DIAGNOSTICCHAIN_MAP);
		...
		createEReference(base1MeasureRelationshipEClass, BASE1_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE);
		createEReference(base1MeasureRelationshipEClass, BASE1_MEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE);
		...
		createEReference(baseNMeasureRelationshipEClass, BASE_NMEASURE_RELATIONSHIP__FROM_COLLECTIVE_MEASURE);
		createEReference(baseNMeasureRelationshipEClass, BASE_NMEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE);
		...
		createEReference(base2MeasureRelationshipEClass, BASE2_MEASURE_RELATIONSHIP__FROM_BINARY_MEASURE);
		createEReference(base2MeasureRelationshipEClass, BASE2_MEASURE_RELATIONSHIP__TO_DIMENSIONAL_MEASURE);
		...
		createEReference(countingMeasureEClass, COUNTING_MEASURE__COUNTED_MEASURE_TO);
		...
		createEReference(measureLibraryEClass, MEASURE_LIBRARY__OWNED_DIAGRAM);
		...
		countingMeasureRelationshipEClass = createEClass(COUNTING_MEASURE_RELATIONSHIP);
		createEReference(countingMeasureRelationshipEClass, COUNTING_MEASURE_RELATIONSHIP__FROM_COUNTING_MEASURE);
		createEReference(countingMeasureRelationshipEClass, COUNTING_MEASURE_RELATIONSHIP__TO_COUNTED_MEASURE);
    ...
    public void initializePackageContents() {
		...
		SMMDIPackage theSMMDIPackage = (SMMDIPackage)EPackage.Registry.INSTANCE.getEPackage(SMMDIPackage.eNS_URI);
		...
		countingMeasureRelationshipEClass.getESuperTypes().add(this.getMeasureRelationship());
		...
		initEAttribute(getSmmElement_Description(), thePrimitiveTypesPackage.getString(), "description", null, 1, 1, SmmElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSmmElement_Name(), thePrimitiveTypesPackage.getString(), "name", null, 1, 1, SmmElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSmmElement_ShortDescription(), thePrimitiveTypesPackage.getString(), "shortDescription", null, 1, 1, SmmElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getArgument_Type(), thePrimitiveTypesPackage.getString(), "type", null, 1, 1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getArgument_Value(), thePrimitiveTypesPackage.getString(), "value", null, 1, 1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getMeasurement_BreakValue(), thePrimitiveTypesPackage.getString(), "breakValue", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMeasurement_Error(), thePrimitiveTypesPackage.getString(), "error", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEOperation(getMeasurement__GetMeasureLabel(), thePrimitiveTypesPackage.getString(), "getMeasureLabel", 1, 1, IS_UNIQUE, !IS_ORDERED);

		initEOperation(getMeasurement__GetMeasurementLabel(), thePrimitiveTypesPackage.getString(), "getMeasurementLabel", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		initEAttribute(getMeasure_MeasureLabelFormat(), thePrimitiveTypesPackage.getString(), "measureLabelFormat", null, 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMeasure_MeasurementLabelFormat(), thePrimitiveTypesPackage.getString(), "measurementLabelFormat", null, 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMeasure_Visible(), thePrimitiveTypesPackage.getBoolean(), "visible", "true", 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMeasure_Source(), thePrimitiveTypesPackage.getString(), "source", null, 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getMeasure_CustomScale(), thePrimitiveTypesPackage.getString(), "customScale", null, 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEOperation(getMeasure__GetAllArguments(), null, "getAllArguments", 1, 1, IS_UNIQUE, !IS_ORDERED);

		initEOperation(getMeasure__GetArguments(), null, "getArguments", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		initEAttribute(getOperation_Body(), thePrimitiveTypesPackage.getString(), "body", null, 1, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getOperation_Language(), thePrimitiveTypesPackage.getString(), "language", null, 1, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEOperation(getOperation__GetParamStrings(), null, "getParamStrings", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		initEAttribute(getScope_Class(), thePrimitiveTypesPackage.getString(), "class", null, 0, 1, Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getScope_Stereotype(), thePrimitiveTypesPackage.getString(), "stereotype", null, 0, 1, Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		EOperation op = initEOperation(getScope__IsSpecified__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "IsSpecified", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getBase1MeasureRelationship_FromBinaryMeasure(), this.getBinaryMeasure(), this.getBinaryMeasure_BaseMeasure1To(), "fromBinaryMeasure", null, 0, 1, Base1MeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBase1MeasureRelationship_ToDimensionalMeasure(), this.getDimensionalMeasure(), null, "toDimensionalMeasure", null, 0, 1, Base1MeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDimensionalMeasure_Formula(), thePrimitiveTypesPackage.getString(), "formula", null, 0, 1, DimensionalMeasure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getBaseNMeasureRelationship_FromCollectiveMeasure(), this.getCollectiveMeasure(), this.getCollectiveMeasure_BaseMeasureTo(), "fromCollectiveMeasure", null, 0, 1, BaseNMeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBaseNMeasureRelationship_ToDimensionalMeasure(), this.getDimensionalMeasure(), null, "toDimensionalMeasure", null, 0, 1, BaseNMeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCollectiveMeasure_BaseMeasureTo(), this.getBaseNMeasureRelationship(), this.getBaseNMeasureRelationship_FromCollectiveMeasure(), "baseMeasureTo", null, 0, -1, CollectiveMeasure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBase2MeasureRelationship_FromBinaryMeasure(), this.getBinaryMeasure(), this.getBinaryMeasure_BaseMeasure2To(), "fromBinaryMeasure", null, 0, 1, Base2MeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBase2MeasureRelationship_ToDimensionalMeasure(), this.getDimensionalMeasure(), null, "toDimensionalMeasure", null, 0, 1, Base2MeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBinaryMeasure_BaseMeasure1To(), this.getBase1MeasureRelationship(), this.getBase1MeasureRelationship_FromBinaryMeasure(), "baseMeasure1To", null, 0, 1, BinaryMeasure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInterval_MaximumEndpoint(), thePrimitiveTypesPackage.getReal(), "maximumEndpoint", null, 0, 1, Interval.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getInterval_MaximumOpen(), thePrimitiveTypesPackage.getBoolean(), "maximumOpen", "false", 0, 1, Interval.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getInterval_MinimumEndpoint(), thePrimitiveTypesPackage.getReal(), "minimumEndpoint", null, 0, 1, Interval.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getDimensionalMeasurement_Value(), thePrimitiveTypesPackage.getReal(), "value", null, 0, 1, DimensionalMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCollectiveMeasurement_IsBaseSupplied(), thePrimitiveTypesPackage.getBoolean(), "isBaseSupplied", null, 1, 1, CollectiveMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getBinaryMeasurement_IsBaseSupplied(), thePrimitiveTypesPackage.getBoolean(), "isBaseSupplied", null, 1, 1, BinaryMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getGradeMeasurement_IsBaseSupplied(), thePrimitiveTypesPackage.getBoolean(), "isBaseSupplied", null, 1, 1, GradeMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getGradeMeasurement_Value(), thePrimitiveTypesPackage.getString(), "value", null, 0, 1, GradeMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getRescaledMeasurement_IsBaseSupplied(), thePrimitiveTypesPackage.getBoolean(), "isBaseSupplied", null, 1, 1, RescaledMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getRankingMeasurement_IsBaseSupplied(), thePrimitiveTypesPackage.getBoolean(), "isBaseSupplied", null, 1, 1, RankingMeasurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getCountingMeasure_CountedMeasureTo(), this.getCountingMeasureRelationship(), this.getCountingMeasureRelationship_FromCountingMeasure(), "countedMeasureTo", null, 0, 1, CountingMeasure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMeasureLibrary_OwnedDiagram(), theSMMDIPackage.getSMMDiagram(), null, "ownedDiagram", null, 0, -1, MeasureLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOCLOperation_Body(), thePrimitiveTypesPackage.getString(), "body", null, 1, 1, OCLOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getOCLOperation_Context(), thePrimitiveTypesPackage.getString(), "context", null, 1, 1, OCLOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(observationEClass, Observation.class, "Observation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getObservation_Observer(), thePrimitiveTypesPackage.getString(), "observer", null, 0, 1, Observation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getObservation_Tool(), thePrimitiveTypesPackage.getString(), "tool", null, 0, 1, Observation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getObservationScope_ScopeUri(), thePrimitiveTypesPackage.getString(), "scopeUri", null, 1, 1, ObservationScope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(countingMeasureRelationshipEClass, CountingMeasureRelationship.class, "CountingMeasureRelationship", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCountingMeasureRelationship_FromCountingMeasure(), this.getCountingMeasure(), this.getCountingMeasure_CountedMeasureTo(), "fromCountingMeasure", null, 1, 1, CountingMeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCountingMeasureRelationship_ToCountedMeasure(), this.getMeasure(), null, "toCountedMeasure", null, 0, 1, CountingMeasureRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
