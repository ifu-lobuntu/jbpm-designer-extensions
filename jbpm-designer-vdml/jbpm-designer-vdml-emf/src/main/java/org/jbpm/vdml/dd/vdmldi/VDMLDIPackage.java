...
public interface VDMLDIPackage extends EPackage {
     ...
     * @ordered
     */
    int VDML_SHAPE__PREVIOUS_WIDTH = JBPMDDPackage.BOUNDARIED_SHAPE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int VDML_SHAPE__PREVIOUS_HEIGHT = JBPMDDPackage.BOUNDARIED_SHAPE_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int VDML_SHAPE__OWNED_SHAPE = JBPMDDPackage.BOUNDARIED_SHAPE_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int VDML_SHAPE_FEATURE_COUNT = JBPMDDPackage.BOUNDARIED_SHAPE_FEATURE_COUNT + 5;
