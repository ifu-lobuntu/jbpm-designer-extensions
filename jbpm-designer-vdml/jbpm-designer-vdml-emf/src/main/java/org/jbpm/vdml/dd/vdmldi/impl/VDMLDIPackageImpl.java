...
public class VDMLDIPackageImpl extends EPackageImpl implements VDMLDIPackage {
    ...
    public EAttribute getVDMLShape_IsExpanded() {
        return (EAttribute)vdmlShapeEClass.getEStructuralFeatures().get(0);
    }
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getVDMLShape_IsExpanded(), theXMLTypePackage.getBoolean(), "isExpanded", "true", 0, 1, VDMLShape.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
